...
function todayView() {
 ...
 }</div></section><section class="side-card note-card"><div class="eyebrow">A NOTE FROM BYTE MILAD</div><p>Close counts. A useful estimate is better than an empty diary. Use grams or a package label when you can.</p></section></aside></div>`;
}
function bindToday() {
  $("#prev-date").onclick = () => {
